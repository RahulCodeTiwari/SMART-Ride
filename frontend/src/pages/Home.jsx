...
const Home = () => {
  return (
    <div>
        <div className='bg-cover bg-center bg-[url(https://unsplash.com/photos/gray-traffic-light-tjDHhOfGAIY)] h-screen pt-5  flex justify-between flex-col w-full bg-red-400 ' >
